...
public class Vista implements Pageable {
    ...
    protected void setSize(float width, float height) {
        ...
        mNumPagesX = (int) ((width + mFormat.getImageableWidth() - 1)/ mFormat.getImageableHeight());
        mNumPagesY = (int) ((height + mFormat.getImageableHeight() - 1)/ mFormat.getImageableHeight());
        mNumPages = mNumPagesX * mNumPagesY;
System.out.println(mNumPagesX+" mNumPagesX "+mNumPagesY);
System.out.println(width+" width "+height);
System.out.println(mFormat.getImageableWidth()+"  mFormat.getImageableHeight() "+mFormat.getImageableHeight());
    }
    /**
    ...
    public Printable getPrintable(int pageIndex) throws IndexOutOfBoundsException {
        ...
        System.out.println(originX+" originX "+originY);
